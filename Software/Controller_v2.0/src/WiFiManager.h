...
#ifndef WIFI_CONNECTION_TM
#define WIFI_CONNECTION_TM 30000
#endif
...
class WiFiManager
{
  public:
    ...
    boolean       startConfigPortal(void (*func)() = NULL);
    boolean       startConfigPortal(char const *apName, char const *apPassword = NULL, void (*func)() = NULL);
...
//***********************************************
// WiFi checkWiFi(). Copyright(C) SAV 18.05.20
//***********************************************
   void setStatusCallback( void (*func)(WM_STATUS st) );
   void checkWiFi(const char *ap_name = NULL, const char *ap_pass = NULL);    
   boolean httpLoopBreak;
  ...
  private:
    ...
    void          setupConfigPortal(void (*func)()=NULL);
    void          startWPS();
...
// sav13 18.05.20	
    void (*_statuscallback)(WM_STATUS stat) = NULL;
	WM_STATUS _wm_status = WMS_OFF;
	uint32_t _wait_connect = 0;
